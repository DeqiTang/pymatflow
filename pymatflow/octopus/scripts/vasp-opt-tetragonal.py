...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--directory", help="directory of the static running", type=str, default="tmp-vasp-opt-tetragonal")
    ...
    parser.add_argument("--isif", type=int, default=2,
            choices=[0, 1, 2],
            help="ISIF = 0-2(must no vc here): refer to https://cms.mpi.univie.ac.at/wiki/index.php/ISIF for how to set the type of Geometri Optimization you need!")
    ...
    server_handle(auto=args.auto, directory=args.directory, jobfilebase="opt-tetragonal", server=args.server)
