...
if __name__ == "__main__":
    ...
    parser.add_argument("--jobname", type=str, default="kpoints-auto",
    ...
    task.converge_kpoints_auto(kmin=args.range[0], kmax=args.range[1], step=args.range[2], directory=args.directory, runopt=args.runopt, auto=args.auto)
