...
if __name__ == "__main__":
    ...
    parser.add_argument("--jobname", type=str, default="phonopy",
    ...
    task.phonopy(directory=args.directory, mpi=args.mpi, runopt=args.runopt, jobname=args.jobname, nodes=args.nodes, ppn=args.ppn)
