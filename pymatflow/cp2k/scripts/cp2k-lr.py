...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--directory", type=str, default="tmp-cp2k-lr",
            help="directory to do cp2k linear response calculation")
    ...
    parser.add_argument("--jobname", type=str, default="linear-response",
    ...
    task.lr(directory=args.directory, runopt=args.runopt, auto=args.auto)
