...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--directory", type=str, default="tmp-cp2k-converge-cutoff",
            help="directory of the calculation")

    parser.add_argument("-f", "--file", type=str,
            help="the xyz structure file name, with second line specifying the cell parameters")
    ...
    parser.add_argument("--jobname", type=str, default="converge-cutoff",
    ...
    task.converge_cutoff(emin=args.range[0], emax=args.range[1], step=args.range[2], directory=args.directory, runopt=args.runopt, auto=args.auto)
