...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--directory", help="directory of the calculation", type=str, default="tmp-cp2k-md-vib")
    ...
    #task.vib(directory=args.directory, runopt=args.runopt, force_eval=force_eval, motion=motion)
    ...
    if args.auto == 0:
        ...
        ctl.login()
        ctl.submit(workdir=args.directory, jobfile="md-vib.inp.sub")
