...
class static_run:
    ...
    def converge_kpoints_auto(self, kmin, kmax, step, directory="tmp-cp2k-kpoints-auto", 
            runopt="gen", force_eval={}):
        """
        Note:
    ...
    def converge_kpoints_manual(self, directory="tmp-cp2k-kpoints-manual", mpi="", runopt="gen", force_eval={},
