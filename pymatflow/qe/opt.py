...
class opt_run(pwscf):
    ...
    def cubic(self, directory="tmp-qe-relax-cubic", runopt="gen", auto=0, na=10, stepa=0.05):
        ...
        with open("relax-cubic.slurm", 'w') as fout:
            ...
            fout.write("  vec31=`echo \"scale=6; result=${c1} * ${a} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
            fout.write("  vec32=`echo \"scale=6; result=${c2} * ${a} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")                                        
            fout.write("  vec33=`echo \"scale=6; result=${c3} * ${a} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")                                          
