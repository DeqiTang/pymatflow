...
class pwscf:
    ...
    def set_kpoints(self, kpoints_option="automatic", kpoints_mp=[2, 2, 2, 0, 0, 0], crystal_b_from=None, crystal_b_manual=None):
        # about the format of crystal_b_from and crystal_b_manual
        # see corresponding comment for function self.arts.set_kpoints()
        self.arts.set_kpoints(option=kpoints_option, kpoints_mp=kpoints_mp, crystal_b_from=crystal_b_from, crystal_b_manual=crystal_b_manual)
