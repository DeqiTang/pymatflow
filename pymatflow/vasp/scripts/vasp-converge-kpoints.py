...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--directory", help="directory of the static running", type=str, default="tmp-vasp-kpoints")
    ...
    parser.add_argument("--range", help="kpoints test range", nargs='+', type=int)
