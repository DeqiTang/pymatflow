...
from pymatflow.vasp.berry import berry_run
"""
usage:
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--directory", type=str, default="tmp-vasp-berry",
            help="directory of the berry phase running")
    ...
    # ----------------------------------------------------------------
    # Berry phase related paramters
    # ----------------------------------------------------------------
    parser.add_argument("--dipol", type=float, nargs="+",
            default=[0.25, 0.25, 0.25],
            help="specifies the center of the cell in direct lattice coordinates with respect to which the total dipole-moment in the cell is calculated.")
    ...
    task.berry(directory=args.directory, runopt=args.runopt, auto=args.auto)
