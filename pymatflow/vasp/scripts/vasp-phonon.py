...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--directory", help="directory of the static running", type=str, default="tmp-vasp-phonon")
    ...
    parser.add_argument("--nsw", type=int, default=1,
            choices=[1],
    ...
    parser.add_argument("--jobname", type=str, default="vasp-phonon",
