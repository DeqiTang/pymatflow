        ...
        with open("opt-tetragonal.slurm", 'w') as fout:
            ...
            if na >= 2:
                ...
                if nc >= 2:
                    ...
                    fout.write("  mkdir relax-${a}-${c}\n")
                    fout.write("  cp POTCAR KPOINTS INCAR relax-${a}-${c}/\n")
                    fout.write("  vec11=`echo \"scale=6; result=${v11} * ${a} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec12=`echo \"scale=6; result=${v12} * ${a} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")                    
                    fout.write("  vec13=`echo \"scale=6; result=${v13} * ${a} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec21=`echo \"scale=6; result=${v21} * ${a} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec22=`echo \"scale=6; result=${v22} * ${a} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec23=`echo \"scale=6; result=${v23} * ${a} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec31=`echo \"scale=6; result=${v31} * ${c} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec32=`echo \"scale=6; result=${v32} * ${c} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")                                        
                    fout.write("  vec33=`echo \"scale=6; result=${v33} * ${c} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")                    
                    fout.write("  cat > relax-${a}-${c}/POSCAR<<EOF\n")
                    fout.write("general comment\n")
                    fout.write("1.0\n")
                    ...
                    fout.write("  vec22=`echo \"scale=6; result=${v22} * ${a} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec23=`echo \"scale=6; result=${v23} * ${a} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec31=`echo \"scale=6; result=${v31} * ${c_in} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec32=`echo \"scale=6; result=${v32} * ${c_in} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")                                        
                    fout.write("  vec33=`echo \"scale=6; result=${v33} * ${c_in} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")                    
                    fout.write("  cat > relax-${a}/POSCAR<<EOF\n")
                    fout.write("general comment\n")
                    fout.write("1.0\n")
                    fout.write("${vec11} ${vec12} ${vec13}\n")
                ...
                if nc >= 2:
                    ...
                    fout.write("  mkdir relax-${c}\n")
                    fout.write("  cp POTCAR KPOINTS INCAR relax-${c}/\n")
                    fout.write("  vec11=`echo \"scale=6; result=${v11} * ${a_in} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec12=`echo \"scale=6; result=${v12} * ${a_in} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")                    
                    fout.write("  vec13=`echo \"scale=6; result=${v13} * ${a_in} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec21=`echo \"scale=6; result=${v21} * ${a_in} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec22=`echo \"scale=6; result=${v22} * ${a_in} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec23=`echo \"scale=6; result=${v23} * ${a_in} / ${a_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec31=`echo \"scale=6; result=${v31} * ${c} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")
                    fout.write("  vec32=`echo \"scale=6; result=${v32} * ${c} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")                                        
                    fout.write("  vec33=`echo \"scale=6; result=${v33} * ${c} / ${c_in}; if (length(result)==scale(result)) print 0; print result\" | bc`\n")                         
                    fout.write("  cat > relax-${c}/POSCAR<<EOF\n")
