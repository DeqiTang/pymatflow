...
requirements:
    ...
    task.input.to_input() must make sure the acell is alway 1 1 1 anstrom
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--directory", type=str, default="tmp-abinit-opt-cubic",
    ...
    parser.add_argument("--optcell", type=int, default=0,
            choices=[0],
