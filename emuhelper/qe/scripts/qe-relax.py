...
if __name__ == "__main__":
    ...
    parser.add_argument("--conv_thr", help="the conv_thr for scf", type=float, default=1.0e-6)
    ...
    task.relax(runopt=args.runopt, mpi=args.mpi, system=system_params, electrons=electrons_params, kpoints_mp=kpoints_mp)
