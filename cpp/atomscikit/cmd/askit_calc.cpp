...
#include "askit/abinit/abinit.h"
#include "askit/cp2k/cp2k.h"
...
int main(int argc, char const* argv[]) {
    ...
    if (cmd == "abinit") {
        ...
        if (vm.count("input")) {
            ...
            crystal = askit::read_structure_file(input_file);
            
            askit::Abinit calculator;
