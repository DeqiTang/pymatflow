...
#ifndef ATOMSCIKIT_INCLUDE_ASKIT_ABINIT_VARIABLE_V1_H_
#define ATOMSCIKIT_INCLUDE_ASKIT_ABINIT_VARIABLE_V1_H_
...
#endif // ATOMSCIKIT_INCLUDE_ASKIT_ABINIT_VARIABLE_V1_H_
