...
int move_along(askit::Crystal* structure, std::vector<int> atoms_to_move, std::vector<int> direc, double disp) {
    /*
    :param structure: an instance of askit::Crystal()
...
int set_frac_min_to_zero(askit::Crystal* structure) {
    /*
    :return an object of askit::Crystal()
    Note:
    ...
    */
    ...
    std::vector<askit::Atom> atoms_frac{structure->atoms};
...
std::vector<askit::Atom> enlarge_atoms_new_cell(askit::Crystal* structure, std::vector<std::vector<double> > new_cell) {
    ...
    */
    ...
    std::vector<askit::Atom> atoms = structure->atoms;
...
int redefine_lattice(askit::Crystal* structure, std::vector<int> a, std::vector<int> b, std::vector<int> c, double precision=1.0e-8) {
    /*
    ...
    */
    ...
    std::vector<askit::Atom> atoms_container = enlarge_atoms_new_cell(structure, new_cell);
    ...
    std::vector<askit::Atom> atoms_frac_within_new_cell;
...
int cleave_surface(askit::Crystal* structure, std::vector<int> direction, double thickness=10, double precision=1.0e-8) {
    /*
...
askit::Crystal merge_layers(askit::Crystal* structure1, askit::Crystal* structure2, int use_cell=0, double distance=3.4, double thickness=10) {
    /*
    ...
    */
    ...
    std::vector<askit::Atom> frac_1;
    std::vector<askit::Atom> frac_2;
...
askit::Crystal build_nanotube_ab(askit::Crystal* structure, std::string axis="b") {
    /*
    :param structure: an instance of crystal()
    :param axis: a or b
    :return an object of crystal()
...
askit::Crystal build_nanotube_ac(askit::Crystal* structure, std::string axis="a") {
    /*
    :param structure: an instance of crystal()
    :param axis: a or c
    :return an object of crystal()
...
askit::Crystal build_nanotube_bc(askit::Crystal* structure, std::string axis="c") {
    /*
    :param structure: an instance of crystal()
    :param axis: b or c
    :return an object of crystal()
